...
public class AgendamentoServicoResource {
	...
	@PostMapping
	private ResponseEntity<AgendamentoServicosIdDTO> cadastrarAgendamento(
			@Validated @RequestBody AgendamentoServico agendamentoServico,
			HttpServletResponse response){
		
		
		
		AgendamentoServico agendamentoSalvo = agendamentoServicoRepository.save(agendamentoServico);
